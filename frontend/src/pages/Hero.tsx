...
import { ArrowRight, Award, BarChart4, BookOpen, Clock, Users } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 space-y-8 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 animate-slide-down delay-300">
                <Button variant="contained" component={Link} to="/register" onClick={() => scrollTo({top:0, behavior: 'smooth'})} className="h-12 px-8">
                  Get Started
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button variant="outlined" component={Link} to="/login" sx={{height: '3rem', px: '2rem', color: 'black'}}>
                  Login
                </Button>
              </div>
            </div>
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl border p-8 shadow-xl">
                <div className="space-y-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="pill bg-blue-100 text-blue-800">Question 3/10</span>
                  </div>
                  <div className="bg-secondary/50 rounded-xl p-4">
                    <p className="font-medium">What is the SI unit of force?</p>
                  </div>
                  <div className="space-y-3">
                    {["Newton", "Joule", "Watt", "Pascal"].map((option, i) => (
                      <div
                        key={option}
                        className={`p-3 rounded-lg border ${
                          i === 0 ? "border-[hsl(210,100%,50%)] bg-[hsl(210,100%,50%)]/5" : "border-border bg-white"
      ...
      <section className="py-16 md:py-24 bg-secondary/30">
        <div className="container max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-on-scroll">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything You Need for Effective Learning</h2>
            <p className="text-xl text-muted-foreground">Our platform combines powerful features to help you excel in your studies</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-[hsl(210,100%,50%)]/10 to-blue-500/10 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-8">
                Join thousands of students who are already improving their skills with our interactive quizzes.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button variant="contained" component={Link} to="/register" sx={{height: '3rem', px: '2rem', color: 'white'}}>
              Create Free Account
                </Button>
